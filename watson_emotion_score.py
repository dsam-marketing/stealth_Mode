...
ENTITIES = ["important", "urgent", "asap", "emergency", "unusual", "bug",
            "error", "compromised", "issue", "software", "voicemail", "quickly"]
NEG_EMOTIONS = ["anger", "disgust", "fear", "sadness"]
POS_EMOTIONS = ["joy"]


authenticator = IAMAuthenticator(
    'iZfTKBZOO9GLYun6JEC2x5UyRX5GaHQP3vmHSgeTX-5m')
natural_language_understanding = NaturalLanguageUnderstandingV1(
    version='2022-04-07',
    authenticator=authenticator
)
natural_language_understanding.set_service_url(
    'https://api.eu-gb.natural-language-understanding.watson.cloud.ibm.com/instances/a8c4b690-e67e-406a-94cd-5fd94a0951ea')
...
def run(input_text):
    ...
    nlu_response = natural_language_understanding.analyze(text=input_text.lower(
    ), features=Features(emotion=EmotionOptions(targets=ENTITIES))).get_result()
...
if __name__ == '__main__':
    texts = ["Hi it’s Mal. We have discussed your mortgage account. There seem to be unusual activity on your account. Please call us or visit branch", "Hi. Can you call me quickly. It’s regarding your loan instalment.",
             "Hi. It’s Sam from IT support. We have fixed the urgent issues you had with your voicemail. Please contact us", "Hi there, this is important, call me! "]
